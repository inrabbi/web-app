...
app.config['MAIL_USERNAME'] = 'lindainvest749@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'ixnqqernewfpnkfv'  # Your Gmail password or App Password
